...
public class EmbeddedFormDisplayerTest {
    ...
    public void init() {
        ...
        displayer.setResizeListener(formContentResizeListener);
    }
    ...
    public void testDisplayForm() {
        ...
        assertEquals(formDisplayer,
                     displayer.getCurrentDisplayer());
        assertEquals(onCloseCommand,
                     displayer.getOnCloseCommand());
        assertEquals(formContentResizeListener,
                     displayer.getResizeListener());
