...
public class FormServiceEntryPointImpl extends AbstractKieServerService implements FormServiceEntryPoint {
    ...
    public FormServiceEntryPointImpl( Instance<FormProvider<? extends FormRenderingSettings>> providersInjected ) {
        providersInjected.forEach( provider -> providers.add( provider ) );
    }
    ...
    public FormRenderingSettings getFormDisplayTask(String serverTemplateId, String domainId, long taskId) {
        ...
        try {
            ...
            for (FormProvider provider : providers) {
                ...
                TaskRenderingSettings settings = new TaskRenderingSettings( taskInstance,inputs, outputs, formContent, new ContentMarshallerContext(null, getKieServicesClient(serverTemplateId, domainId).getClassLoader()) );
    ...
    public FormRenderingSettings getFormDisplayProcess( String serverTemplateId, String domainId, String processId) {
        ...
        try {
            ...
            if (formContent != null) {
                ...
                ProcessRenderingSettings settings = new ProcessRenderingSettings( processDesc, processData, formContent, new ContentMarshallerContext(null, getKieServicesClient(serverTemplateId, domainId).getClassLoader()) );
