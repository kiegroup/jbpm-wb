 ...
 * </p>
 */
public class JBPMSimplePager<T> extends AbstractPager {
    ...
    private GenericDataProvider<T> dataProvider;
    ...
    public JBPMSimplePager(TextLocation location) {
        this(location, getDefaultResources(), false, DEFAULT_FAST_FORWARD_ROWS, false);
    }
    ...
    public boolean hasNextPage() {
        ...
        if (dataProvider != null && dataProvider.getAllServerSideData() != null) {
            return (dataProvider.getClientSideDataProvider().getList().size() > (DataGridUtils.pageSize * (currentPage + 1)) );
        }
        return false;
    }
...
//        }
        ...
        if (dataProvider != null && (endIndex > (dataSize - this.pageSize - 2))) {
                dataProvider.refresh( ((currentPage + 1) * this.pageSize), 
                    this.pageSize , false);
        }
        super.nextPage();
