...
import static org.jbpm.workbench.common.client.PerspectiveIds.TASK_LIST_ADVANCED_FILTERS_SCREEN;

@ApplicationScoped
@WorkbenchScreen(identifier = TASK_LIST_ADVANCED_FILTERS_SCREEN)
public class TaskListAdvancedFiltersPresenter extends AdvancedFiltersPresenter {
    ...
    public String getAdvancedFiltersEditorScreenId() {
        return TASK_LIST_ADVANCED_FILTERS_SCREEN;
    }
}
