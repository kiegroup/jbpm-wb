...
public interface KnowledgeDomainService {
    ...
    Collection<ProcessInstance> getProcessInstancesBySessionId(String sessionId);

    Collection<String> getSessionsNames();

    Collection<org.drools.definition.process.Process> getProcessesBySessionId(String sessionId);
