...
public class CaseRolesPresenterTest extends AbstractCaseInstancePresenterTest {
    ...
    public void testFiltering() {
        ...
        roles.put(caseRole_1,
                  -1);
        roles.put(caseRole_2,
                  2);
        roles.put(caseRole_3,
                  1);
        ...
        verify(view,
               times(2)).setRolesAssignmentList(captor2.capture());
        assertEquals(2,
        ...
        verify(view,
               times(3)).setRolesAssignmentList(captor3.capture());
        assertEquals(1,
    ...
    public void testEditAction() {
        ...
        verify(caseManagementService).assignUserToRole(eq(serverTemplateId),
                                                       eq(caseInstance.getContainerId()),
                                                       eq(caseInstance.getCaseId()),
                                                       eq(CASE_ROLE),
                                                       eq(newUser));
        verify(caseManagementService).assignGroupToRole(eq(serverTemplateId),
                                                        eq(caseInstance.getContainerId()),
                                                        eq(caseInstance.getCaseId()),
                                                        eq(CASE_ROLE),
                                                        eq(newGroup));
    ...
    public void testSetupNewRoleAssignments_rolesNotDefined() {
        ...
        verify(view,
               never()).setRolesAssignmentList(anyList());
    }

    @Test
    public void testAssignToRole_rolesAvailableForAssignment() {
        CaseRoleAssignmentSummary previous = createTestCaseRoleAssignmentSummary(CASE_ROLE,
                                                                                 EMPTY_LIST,
                                                                                 EMPTY_LIST);
        ...
        when(caseRolesValidations.validateRolesAssignments(nullable(CaseDefinitionSummary.class),
                                                           nullable(List.class))).thenReturn(Arrays.asList("error"));
        ...
        verify(caseManagementService,
               never()).assignUserToRole(anyString(),
                                         anyString(),
                                         anyString(),
                                         anyString(),
                                         anyString());
        ...
        when(caseRolesValidations.validateRolesAssignments(nullable(CaseDefinitionSummary.class),
                                                           nullable(List.class))).thenReturn(EMPTY_LIST);
        ...
        verify(caseManagementService,
               times(2)).assignUserToRole(nullable(String.class),
    ...
    public void testStoreRoleAssignments_removePreviousUser() {
        ...
        verifyStoreRoleAssignmentsCalls(0,
                                        ...
                                        1,
                                        1);
        verify(caseManagementService).removeUserFromRole(nullable(String.class),
                                                         nullable(String.class),
                                                         nullable(String.class),
                                                         anyString(),
                                                         eq("test_user"));
        verify(caseManagementService).removeGroupFromRole(nullable(String.class),
                                                          nullable(String.class),
                                                          nullable(String.class),
                                                          anyString(),
                                                          eq("test_group"));
    ...
    public void testStoreRoleAssignments_replaceAssignment() {
        ...
        verify(caseManagementService).assignUserToRole(nullable(String.class),
                                                       nullable(String.class),
                                                       nullable(String.class),
                                                       anyString(),
                                                       eq(USER));
        verify(caseManagementService).assignGroupToRole(nullable(String.class),
                                                        nullable(String.class),
                                                        nullable(String.class),
                                                        anyString(),
                                                        eq(GROUP));
    ...
    private void verifyStoreRoleAssignmentsCalls(int timesAddUser,
        ...
        verify(caseManagementService,
               times(timesAddUser)).assignUserToRole(nullable(String.class),
                                                     nullable(String.class),
                                                     nullable(String.class),
                                                     anyString(),
                                                     anyString());
        verify(caseManagementService,
               times(timesAddGroup)).assignGroupToRole(nullable(String.class),
                                                       nullable(String.class),
                                                       nullable(String.class),
                                                       anyString(),
                                                       anyString());
        verify(caseManagementService,
               times(timesRemoveUser)).removeUserFromRole(nullable(String.class),
                                                          nullable(String.class),
                                                          nullable(String.class),
                                                          anyString(),
                                                          anyString());
        verify(caseManagementService,
               times(timesRemoveGroup)).removeGroupFromRole(nullable(String.class),
                                                            nullable(String.class),
                                                            nullable(String.class),
                                                            anyString(),
                                                            anyString());
