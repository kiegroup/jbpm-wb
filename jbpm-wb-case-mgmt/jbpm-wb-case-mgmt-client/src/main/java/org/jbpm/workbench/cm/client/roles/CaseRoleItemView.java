            ...
            addAction(new CaseRolesPresenter.CaseRoleAction() {
                ...
                public void execute() {
                    confirmPopup.show(translationService.format(REMOVE_ASSIGNMENT),
                            ...
                            () -> presenter.storeRoleAssignments(model, Collections.emptyList(),
                        ...
                        itemsList.add(new CaseRolesPresenter.CaseAssignmentItem() {
                            ...
                            public void execute() {
                                confirmPopup.show(translationService.format(REMOVE_ASSIGNMENT),
                                        ...
                                        () -> presenter.removeUserFromRole(user, caseRoleAssignmentSummary.getModel()));
                            }
                        }));
                        ...
                        itemsList.add((new CaseRolesPresenter.CaseAssignmentItem() {
                            ...
                            public void execute() {
                                confirmPopup.show(translationService.format(REMOVE_ASSIGNMENT),
                                        ...
                                        () -> presenter.removeGroupFromRole(group, caseRoleAssignmentSummary.getModel()));
