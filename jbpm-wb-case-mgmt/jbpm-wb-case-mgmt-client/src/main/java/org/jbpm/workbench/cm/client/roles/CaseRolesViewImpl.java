...
public class CaseRolesViewImpl  extends AbstractView<CaseRolesPresenter>
    ...
    public void init() {
        ...
        tooltip(rolesBadge);
        rolesBadge.setAttribute("data-original-title", translationService.format(TOTAL_NUMBER_OF_ROLES));
    ...
    public void setRolesAssignmentList(final List<CaseRoleAssignmentSummary> caseRoleAssignmentSummaryList) {
        ...
        pagination.init(caseRoleAssignmentSummaryList, this, PAGE_SIZE);
    }
