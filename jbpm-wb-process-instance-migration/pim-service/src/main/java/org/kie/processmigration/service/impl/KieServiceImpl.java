...
public class KieServiceImpl implements KieService {
    ...
    public UIServicesClient getUIServicesClient(String kieServerId) throws InvalidKieServerException {
        if (!kieServices.containsKey(kieServerId)) {
            throw new InvalidKieServerException(kieServerId);
        }
        return (UIServicesClient) kieServices.get(kieServerId).getServicesClient(UIServicesClient.class);
    }

    public ProcessServicesClient getProcessServicesClient(String kieServerId) throws InvalidKieServerException {
        if (!kieServices.containsKey(kieServerId)) {
            throw new InvalidKieServerException(kieServerId);
        }
        return (ProcessServicesClient) kieServices.get(kieServerId).getServicesClient(ProcessServicesClient.class);
    }
