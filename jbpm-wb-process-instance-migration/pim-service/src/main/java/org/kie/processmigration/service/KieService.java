...
public interface KieService {
    ...
    UIServicesClient getUIServicesClient(String kieserverId) throws InvalidKieServerException;

    ProcessServicesClient getProcessServicesClient(String kieserverId) throws InvalidKieServerException;
