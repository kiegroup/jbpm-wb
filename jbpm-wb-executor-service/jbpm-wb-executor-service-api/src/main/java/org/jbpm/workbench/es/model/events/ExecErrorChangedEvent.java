...
@Portable
public class ExecErrorChangedEvent implements Serializable {

    private String deploymentId;
    private String errorId;
    private String serverTemplateId;

    public ExecErrorChangedEvent() {
    }

    public ExecErrorChangedEvent(String serverTemplateId,
                                 String deploymentId,
                                 String errorId) {
    ...
    public boolean equals(Object obj) {
        ...
        final ExecErrorChangedEvent other = (ExecErrorChangedEvent) obj;
