...
@Portable
public class ExecErrorSelectionEvent {

    private String deploymentId;
    private String errorId;
    private String serverTemplateId;

    public ExecErrorSelectionEvent() {
    }

    public ExecErrorSelectionEvent(String serverTemplateId,
                                   String deploymentId,
                                   String errorId) {
    ...
    public boolean equals(Object obj) {
        ...
        final ExecErrorSelectionEvent other = (ExecErrorSelectionEvent) obj;
