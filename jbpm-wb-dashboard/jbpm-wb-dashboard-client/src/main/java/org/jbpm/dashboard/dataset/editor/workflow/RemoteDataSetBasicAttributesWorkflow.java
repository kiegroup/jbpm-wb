 ...
 */
@Dependent
public class RemoteDataSetBasicAttributesWorkflow extends DataSetBasicAttributesWorkflow<RemoteDataSetDef, org.jbpm.dashboard.dataset.editor.RemoteDataSetDefAttributesEditor> {
    ...
    @Override
    protected Class<? extends SimpleBeanEditorDriver<RemoteDataSetDef, org.jbpm.dashboard.dataset.editor.RemoteDataSetDefAttributesEditor>> getDriverClass() {
        return RemoteDataSetDefAttributesDriver.class;
    }

    @Override
    protected Class<? extends org.jbpm.dashboard.dataset.editor.RemoteDataSetDefAttributesEditor> getEditorClass() {
        return org.jbpm.dashboard.dataset.editor.impl.RemoteDataSetDefAttributesEditor.class;
    }
