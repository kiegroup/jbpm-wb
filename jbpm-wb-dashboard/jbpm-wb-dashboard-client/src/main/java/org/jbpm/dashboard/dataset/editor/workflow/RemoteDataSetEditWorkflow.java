 ...
 */
@Dependent
public class RemoteDataSetEditWorkflow extends DataSetEditWorkflow<RemoteDataSetDef, org.jbpm.dashboard.dataset.editor.RemoteDataSetDefEditor> {
    ...
    @Override
    protected Class<? extends SimpleBeanEditorDriver<RemoteDataSetDef, org.jbpm.dashboard.dataset.editor.RemoteDataSetDefEditor>> getDriverClass() {
        return RemoteDataSetDefDriver.class;
    }

    @Override
    protected Class<? extends org.jbpm.dashboard.dataset.editor.RemoteDataSetDefEditor> getEditorClass() {
        return org.jbpm.dashboard.dataset.editor.impl.RemoteDataSetEditor.class;
    }
