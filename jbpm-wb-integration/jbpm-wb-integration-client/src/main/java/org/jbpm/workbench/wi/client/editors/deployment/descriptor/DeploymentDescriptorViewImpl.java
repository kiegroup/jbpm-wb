...
public class DeploymentDescriptorViewImpl extends KieEditorViewImpl implements DeploymentDescriptorView {
    ...
    public void setContent(DeploymentDescriptorModel deploymentDescriptorModel) {
        ...
        setSelectedValue(persistenceModeDropdown,
                         deploymentDescriptorModel.getPersistenceMode());
        setSelectedValue(auditModeDropdown,
                         deploymentDescriptorModel.getAuditMode());
        setSelectedValue(runtimeStrategyDropdown,
                         deploymentDescriptorModel.getRuntimeStrategy());
    ...
    public void onClickAddMarshalStrategyButton(final ClickEvent event) {
        marshalStrategyDataProvider.getList().add(new ItemObjectModel("",
                                                                      constants.EnterValue(),
                                                                      constants.EnterResolverType(),
                                                                      null));
    }
    ...
    private void configureMarshalingTable() {
        ...
        final ButtonCell parametersMSButton = new ButtonCell(IconType.ADJUST,
                                                             ButtonType.PRIMARY,
                                                             ButtonSize.SMALL);
    ...
    public void onClickAddEventListenersButton(final ClickEvent event) {
        eventListenersDataProvider.getList().add(new ItemObjectModel("",
                                                                     constants.EnterValue(),
                                                                     constants.EnterResolverType(),
                                                                     null));
    }
    ...
    public void onClickAddGlobalsButton(final ClickEvent event) {
        globalsDataProvider.getList().add(new ItemObjectModel("",
                                                              constants.EnterValue(),
                                                              constants.EnterResolverType(),
                                                              null));
    }
    ...
    public void onClickAddWorkItemHandlersButton(final ClickEvent event) {
        workItemHandlersDataProvider.getList().add(new ItemObjectModel("",
                                                                       constants.EnterValue(),
                                                                       constants.EnterResolverType(),
                                                                       null));
    }
    ...
    public void onClickAddTaskEventListenersButton(final ClickEvent event) {
        taskEventListenersDataProvider.getList().add(new ItemObjectModel("",
                                                                         constants.EnterValue(),
                                                                         constants.EnterResolverType(),
                                                                         null));
    }
    ...
    public void onClickAddEnvironmentEntriesButton(final ClickEvent event) {
        environmentEntriesDataProvider.getList().add(new ItemObjectModel("",
                                                                         constants.EnterValue(),
                                                                         constants.EnterResolverType(),
                                                                         null));
    }
    ...
    public void onClickAddConfigurationButton(final ClickEvent event) {
        configurationDataProvider.getList().add(new ItemObjectModel("",
                                                                    constants.EnterValue(),
                                                                    constants.EnterResolverType(),
                                                                    null));
    }
    ...
    private void configureRequiredRolesTable() {
        ...
        valueColumn.setFieldUpdater(new FieldUpdater<String, String>() {
            ...
            public void update(int index,
                ...
                requiredRolesDataProvider.getList().add(index,
                                                        value);
            }
        });
    ...
    private void configureRemoteableClassesTable() {
        ...
        valueColumn.setFieldUpdater(new FieldUpdater<String, String>() {
            ...
            public void update(int index,
                ...
                remoteableClassesDataProvider.getList().add(index,
                                                            value);
            }
        });
    ...
    @Override
    public void addRuntimeStrategy(String runtimeStrategyTitle,
                                   String runtimeStrategyValue) {
        runtimeStrategyDropdown.addItem(runtimeStrategyTitle,
                                        runtimeStrategyValue);
    }

    @Override
    public void addPersistenceMode(String persistenceModeTitle,
                                   String persistenceModeValue) {
        persistenceModeDropdown.addItem(persistenceModeTitle,
                                        persistenceModeValue);
    }

    @Override
    public void addAuditMode(String auditModeTitle,
                             String auditModeValue) {
        auditModeDropdown.addItem(auditModeTitle,
                                  auditModeValue);
    }
