 ...
 */
public class ActionHistoryPresenterActivity extends AbstractWorkbenchScreenActivity {
    ...
    @Inject
    private ActionHistoryPresenter realPresenter;

    @Inject
    //Constructor injection for testing
    public ActionHistoryPresenterActivity(final PlaceManager placeManager) {
        super( placeManager );
    }
    ...
    public String getSignatureId() {
        return "org.jbpm.console.ng.he.client.history.ActionHistoryPresenterActivity";
    }
}
