...
@Portable
public class UsageEventSummary implements Serializable {
    ...
    public UsageEventSummary(String key, String component, String action, String user, String status, String level,
            String module) {
        this.key = key;
