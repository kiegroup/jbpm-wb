...
public class NodeInstanceLogHelper {
    ...
    public static List<NodeInstanceLogSummary> adaptCollection( Collection<NodeInstanceDesc> nodeInstances ) {
        ...
        for ( NodeInstanceDesc ni : nodeInstances ) {
            if ( ni.getNodeType().equals( NodeInstanceLogSummary.NODE_TYPE_ENDNODE ) || ni.getNodeType().equals( NodeInstanceLogSummary.NODE_TYPE_STARTNODE )
                    || ni.getNodeType().equals( NodeInstanceLogSummary.NODE_TYPE_WORKITEMNODE ) || ni.getNodeType().equals( NodeInstanceLogSummary.NODE_TYPE_HUMANTASK )
                    || ni.getNodeType().equals( NodeInstanceLogSummary.NODE_TYPE_SUBPROCESSNODE ) ) {
