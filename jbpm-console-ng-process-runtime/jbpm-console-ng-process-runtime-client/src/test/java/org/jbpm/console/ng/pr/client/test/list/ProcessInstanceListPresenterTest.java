...
public class ProcessInstanceListPresenterTest {
    ...
    private DataSetReadyCallback genericCallbackMock;
    
    private DataSetReadyCallback domainSpecificCallbackMock;
    ...
    public void setupMocks() {
        ...
        presenter = new DataSetProcessInstanceWithVariablesListPresenter(viewMock, dataSetQueryHelperMock);   
    }

    @Test
    public void domainSpecificColumnsWithPagination() {
         genericCallbackMock = new DataSetReadyCallback() {
            ...
            public void callback(DataSet dataSet) {
                ...
                presenter.getDomainSpecifDataForProcessInstances(0, dataSet, "mock", new ArrayList<ProcessInstanceSummary>());                
            }
        ...
        domainSpecificCallbackMock = new DataSetReadyCallback() {

            @Override
            public void callback(DataSet dataSet) {
                verify(dataSetQueryHelperMock, times(2)).setLastSortOrder(SortOrder.ASCENDING);
                verify(dataSetQueryHelperMock, times(1)).setLastOrderedColumn("pid");
        ...
        presenter.setProcessInstanceCallback(genericCallbackMock);
        presenter.setDataSetDomainSpecifCallback(domainSpecificCallbackMock);
