...
@Dependent
public class ProcessInstanceDetailsWholeViewImpl extends Composite implements ProcessInstanceDetailsPresenter.ProcessInstanceDetailsWholeViewUpdate {
    ...
    @Inject
    private ProcessInstanceDetailsPresenter.ProcessInstanceLogView logView;
    ...
    @UiField
    public HTMLPanel parentsLogView;
    ...
    @Override
    public ProcessInstanceDetailsPresenter.ProcessInstanceLogView getHistoryLogView() {
        return logView;
    }
