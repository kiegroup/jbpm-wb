...
public class ProcessInstanceDetailsViewImpl extends Composite implements ProcessInstanceDetailsPresenter.ProcessInstanceDetailsView {
    ...
    @UiField
    public HTML processDefinitionIdLabel;

    @UiField
    public HTML processDeploymentLabel;

    @UiField
    public HTML processVersionLabel;

    @UiField
    public HTML correlationKeyLabel;

    @UiField
    public HTML stateLabel;

    @UiField
    public HTML parentProcessInstanceIdText;

    @UiField
    public HTML parentProcessInstanceIdLabel;
    ...
    public void initLables() {
        processDefinitionIdLabel.setHTML( setStrong( constants.Process_Definition_Id() ) );
        processDeploymentLabel.setHTML( setStrong( constants.Deployment_Name() ) );
        processVersionLabel.setHTML( setStrong( constants.Process_Definition_Version() ) );
        correlationKeyLabel.setHTML( setStrong( constants.Correlation_Key() ) );
        stateLabel.setHTML( setStrong( constants.Process_Instance_State() ) );
        parentProcessInstanceIdLabel.setHTML( setStrong( constants.Parent_Process_Instance() ) );
    }

    private String setStrong( String text ) {
