...
public class UserTaskListHistoryPresenter extends AbstractListPresenter<UserTaskSummary> {
    ...
    public interface UserTaskListHistoryView extends AbstractListView.BasicListView<UserTaskSummary> {
    ...
    @Inject
    private Caller<ProcessUserTasksService> processUserTasksService;
    ...
    @PostConstruct
    public void init() {
        dataProvider = new AsyncDataProvider<UserTaskSummary>() {

            @Override
            protected void onRangeChanged( HasData<UserTaskSummary> display ) {
                ...
                if ( processInstanceId != null  ) {
                    ...
                    processUserTasksService.call( new RemoteCallback<PageResponse<UserTaskSummary>>() {
                        @Override
                        public void callback( PageResponse<UserTaskSummary> response ) {
                        ...
                        public boolean error( Message message,
                                              Throwable throwable ) {
                            view.hideBusyIndicator();
                            view.displayNotification( "Error: Getting User Tasks of Process instance: " + message );
