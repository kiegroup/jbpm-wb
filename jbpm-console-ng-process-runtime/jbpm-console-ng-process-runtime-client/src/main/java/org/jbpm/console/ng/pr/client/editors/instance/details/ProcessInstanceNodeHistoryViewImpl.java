...
public class ProcessInstanceNodeHistoryViewImpl extends AbstractListView<NodeInstanceLogSummary, ProcessInstanceDetailsPresenter> implements
    ...
    private Column initActionsColumn() {
        ...
        cells.add( new UserTaskWorkDetailsActionHasCell( constants.User_Task_Work_Details(), new Delegate<NodeInstanceLogSummary>() {
    ...
    private class UserTaskWorkDetailsActionHasCell implements HasCell<NodeInstanceLogSummary, NodeInstanceLogSummary> {

        private ActionCell<NodeInstanceLogSummary> cell;

        public UserTaskWorkDetailsActionHasCell(String text, Delegate<NodeInstanceLogSummary> delegate) {
            cell = new ActionCell<NodeInstanceLogSummary>( text, delegate ) {
