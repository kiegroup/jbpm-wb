...
### Code style ###
Following are the basic code style rules used in jBPM WB, full guidelines are described in [kiegroup README file](https://github.com/kiegroup/droolsjbpm-build-bootstrap/blob/main/README.md).
