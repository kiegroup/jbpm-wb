...
public class CaseActionMapper implements Function<TaskSummary, CaseActionSummary> {

    @Override
    public CaseActionSummary apply(TaskSummary taskSummary) {
        if (taskSummary == null) {
            return null;
        }
        ...
        return CaseActionSummary.builder()
                ...
                .skipable(taskSummary.getSkipable())
                ...
                .containerId(taskSummary.getContainerId())
                .parentId(taskSummary.getParentId())
                .build();
    }
