...
public class CaseActionAdhocFragmentMapperTest {
    ...
    public static void assertCaseActionAdHocFragment(final CaseAdHocFragment cc, final CaseActionSummary ccs) {
        ...
        assertEquals(cc.getType(),ccs.getDescription());
        assertEquals("AdhocFragment",ccs.getStatus());
    }
    ...
    public void testCaseActionAdhocFragmentMapper_mapCaseAction() {
        ...
        final CaseActionSummary ccs = new CaseActionAdhocFragmentMapper().apply(cc);
