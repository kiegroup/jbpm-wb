...
@Dependent
@Templated
public class CaseCommentsViewImpl extends Composite implements CaseCommentsPresenter.CaseCommentsView {
    ...
    Element newCommentTextAreaGroup = DOM.createDiv();
    ...
    public void clearErrorMessages() {
        ...
        setFormGroupStyle(newCommentTextAreaGroup, ValidationState.NONE);
    }
    ...
    private boolean validateForm() {
        ...
        if (newCommentEmpty) {
            ...
            setFormGroupStyle(newCommentTextAreaGroup, ValidationState.ERROR);
            return false;
        }
        return true;
    }
