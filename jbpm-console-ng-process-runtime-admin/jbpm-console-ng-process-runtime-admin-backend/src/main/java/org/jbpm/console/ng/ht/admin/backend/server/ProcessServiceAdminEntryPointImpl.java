...
import org.jbpm.console.ng.ht.admin.service.ProcessServiceAdminEntryPoint;
...
public class ProcessServiceAdminEntryPointImpl implements ProcessServiceAdminEntryPoint {
    ...
    @Override
    public void generateMockInstances(String deploymentId, String processId, int amountOfTasks) {
