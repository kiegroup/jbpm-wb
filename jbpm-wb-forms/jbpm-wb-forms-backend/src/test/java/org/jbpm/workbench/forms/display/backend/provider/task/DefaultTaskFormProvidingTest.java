...
public class DefaultTaskFormProvidingTest extends AbstractTaskFormProvidingTest<KieWorkbenchFormsProvider> {

    @Override
    protected void initFormsProvider() {
        this.workbenchFormsProvider = new KieWorkbenchFormsProvider(null,
                                                                    processor);
    }
}
