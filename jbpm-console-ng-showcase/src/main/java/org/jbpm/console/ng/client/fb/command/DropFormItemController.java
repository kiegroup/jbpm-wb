 ...
 */
package org.jbpm.console.ng.client.fb.command;
...
import org.jbpm.console.ng.client.fb.view.canvas.CanvasView;
...
import org.jbpm.form.builder.ng.model.common.panels.MovablePanel;
...
public class DropFormItemController extends AbstractDropController {
    ...
    public void onDrop(DragContext context) {
        ...
        System.out.println("DROPPED COMPONENT :"+x + "-- "+y);
