...
import org.jbpm.console.ng.gc.client.experimental.workbranch.configuration.WorkbranchConfigureationMenuBuilder;
...
public class ShowcaseEntryPoint {
    ...
    private void setupMenu() {
        ...
        final Menus menus = MenuFactory
                ...
                .newTopLevelCustomMenu( iocManager.lookupBean( WorkbranchConfigureationMenuBuilder.class).getInstance() ).endMenu()
