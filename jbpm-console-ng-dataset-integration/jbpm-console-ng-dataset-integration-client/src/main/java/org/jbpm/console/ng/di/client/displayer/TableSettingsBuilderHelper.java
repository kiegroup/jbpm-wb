 ...
 */
public final class TableSettingsBuilderHelper {
    TableSettingsBuilder builder = TableSettingsBuilder.init();

    public static TableSettingsBuilderHelper init() {
        return new TableSettingsBuilderHelper();
    }

    public void initBuilder() {
        builder = TableSettingsBuilder.init();
    }
    ...
    public TableSettings buildSettings() {
        return ( TableSettings ) builder.buildSettings();
    }
