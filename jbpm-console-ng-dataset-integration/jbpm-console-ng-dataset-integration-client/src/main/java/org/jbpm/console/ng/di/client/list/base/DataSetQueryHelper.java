...
import org.jbpm.console.ng.di.client.displayer.dataset.DataSetHandler;
import org.jbpm.console.ng.di.client.displayer.dataset.DataSetHandlerImpl;
...
public class DataSetQueryHelper<T> {
    ...
    public void setCurrentTableSettings(TableSettings tableSettings){
    ...
    public TableSettings getCurrentTableSetting() {
        return currentTableSetting;
    }

    public void setCurrentTableSetting( TableSettings currentTableSetting ) {
    ...
    public void setDataSetHandler(TableSettings tableSettings) {
