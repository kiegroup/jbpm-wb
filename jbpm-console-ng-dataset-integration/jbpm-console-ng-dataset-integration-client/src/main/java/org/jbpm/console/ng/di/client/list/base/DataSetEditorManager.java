 ...
 */
package org.jbpm.console.ng.di.client.list.base;

import com.google.gwt.user.client.ui.Composite;
import org.jboss.errai.security.shared.api.identity.User;

import org.jbpm.console.ng.di.client.displayer.TableDisplayerEditorPopup;
import org.jbpm.console.ng.di.client.displayer.TableSettings;
import org.jbpm.console.ng.di.client.displayer.TableSettingsJSONMarshaller;
...
public class DataSetEditorManager extends Composite  {
    ...
    public void showTableSettingsEditor(final FilterPagedTable filterPagedTable ,String popupTitle, final TableSettings tableSettings,final Command drawCommand) {
        ...
        tableDisplayerEditorPopup.show( clone, new TableDisplayerEditorPopup.Listener() {

            public void onClose( TableDisplayerEditorPopup editor ) {
            }

            public void onSave( TableDisplayerEditorPopup editor ) {
                TableSettings modifiedSettings = editor.getTableDisplayerSettings();
