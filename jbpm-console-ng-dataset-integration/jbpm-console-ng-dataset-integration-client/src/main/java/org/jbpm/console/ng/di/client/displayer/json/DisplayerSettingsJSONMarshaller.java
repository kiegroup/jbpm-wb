...
public class DisplayerSettingsJSONMarshaller {
        ...
        if ( !StringUtils.isBlank( jsonString ) ) {
            ...
            if ( parseResult != null ) {
                ...
                if ( data != null ) {
                    ...
                    throw new RuntimeException( TableDisplayerConstants.INSTANCE.json_displayersettings_dataset_lookup_notspecified() );
                }
        ...
        for ( int i = 0; i < columnSettingsList.size(); i++ ) {
            ...
            if ( !StringUtils.isBlank( id ) ) {
                ...
                if ( !StringUtils.isBlank( expression ) )
                    columnJson.put( COLUMN_EXPRESSION, new JSONString( expression ) );
    ...
    private List<ColumnSettings> parseColumnsFromJson( JSONArray columnsJsonArray ) {
        ...
        for ( int i = 0; i < columnsJsonArray.size(); i++ ) {
            ...
            if ( value == null )
                throw new RuntimeException( TableDisplayerConstants.INSTANCE.json_columnsettings_null_columnid() );
