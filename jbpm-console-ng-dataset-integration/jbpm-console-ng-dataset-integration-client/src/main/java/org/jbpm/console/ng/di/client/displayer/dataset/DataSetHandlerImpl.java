 ...
 */
package org.jbpm.console.ng.di.client.displayer.dataset;
...
public class DataSetHandlerImpl implements DataSetHandler {
    ...
    public boolean filter( DataSetGroup op ) {
        ...
        if ( cg == null )
            throw new RuntimeException( TableDisplayerConstants.INSTANCE.datasethandler_groupops_no_pivotcolumn() );
        if ( !op.isSelect() )
            throw new RuntimeException( TableDisplayerConstants.INSTANCE.datasethandler_groupops_no_groupintervals() );
