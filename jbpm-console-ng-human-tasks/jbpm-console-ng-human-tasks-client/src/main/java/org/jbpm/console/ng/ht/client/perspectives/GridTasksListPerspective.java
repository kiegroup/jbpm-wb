 ...
 */
@ApplicationScoped
@WorkbenchPerspective(identifier = "Grid Tasks", isDefault = false)
public class GridTasksListPerspective {
    ...
    public PerspectiveDefinition getPerspective() {
        ...
        p.setName( "Grid Tasks" );
        p.getRoot().addPart( new PartDefinitionImpl( new DefaultPlaceRequest( "Grid Tasks List" ) ) );
        p.setTransient( true );
        return p;
    }
