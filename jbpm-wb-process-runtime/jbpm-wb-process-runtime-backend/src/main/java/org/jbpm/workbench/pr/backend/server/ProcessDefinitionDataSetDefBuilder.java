...
public class ProcessDefinitionDataSetDefBuilder extends BeanDataSetDefBuilderImpl {
    ...
    public ProcessDefinitionDataSetDefBuilder serverTemplateId(String serverTemplateId) {
        ((ProcessDefinitionDataSetDef) def).setServerTemplateId(serverTemplateId);
        return this;
    }
