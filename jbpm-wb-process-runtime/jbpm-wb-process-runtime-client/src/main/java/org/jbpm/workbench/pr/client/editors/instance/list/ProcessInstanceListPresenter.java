...
public class ProcessInstanceListPresenter extends AbstractMultiGridPresenter<ProcessInstanceSummary, ProcessInstanceListPresenter.ProcessInstanceListView> {
    ...
    public void setupAdvanceSearchView() {
        ...
        //TODO review to get list from database
//        getProcessDefinitions(pds -> {
//            final Map<String, String> process = pds.stream().collect(toMap(ProcessSummary::getProcessDefId,
//                                                                           ProcessSummary::getProcessDefName));
//            view.addSelectFilter(constants.Name(),
//                                 process,
//                                 true,
