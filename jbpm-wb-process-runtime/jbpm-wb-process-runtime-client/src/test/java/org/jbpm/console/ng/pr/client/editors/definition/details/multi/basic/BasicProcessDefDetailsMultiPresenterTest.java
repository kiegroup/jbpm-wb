...
import org.jbpm.console.ng.pr.client.editors.definition.details.multi.BaseProcessDefDetailsMultiPresenterTest;
...
public class BasicProcessDefDetailsMultiPresenterTest extends BaseProcessDefDetailsMultiPresenterTest {
    ...
    @Override
    public BaseProcessDefDetailsMultiPresenter getPresenter() {
        return presenter;
    }
}