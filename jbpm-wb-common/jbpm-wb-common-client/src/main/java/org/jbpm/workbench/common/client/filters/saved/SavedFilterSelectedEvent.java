...
public class SavedFilterSelectedEvent {

    private SavedFilter savedFilter;

    public SavedFilterSelectedEvent(final SavedFilter savedFilter) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SavedFilterSelectedEvent)) {
            return false;
        }

        SavedFilterSelectedEvent that = (SavedFilterSelectedEvent) o;
