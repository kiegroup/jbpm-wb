...
public class DateUtils {
    ...
    public static DateRange getWorkWeekDateRange(Date date) {
        return getDateRangeStartingOnMonday(date,
                                            5);
    }
    ...
    private static DateRange getDateRangeStartingOnMonday(Date dateWithinTheWeek,
                                                          int nrOfDaysTotal) {
        ...
        CalendarUtil.addDaysToDate(startDate,
                                   -daysAfterMonday);
    ...
    public static DateRange getMonthDateRange(Date date) {
        ...
        CalendarUtil.addMonthsToDate(endDate,
                                     1);
        CalendarUtil.addDaysToDate(endDate,
                                   -1);
        endDate.setHours(0);
    ...
    public static int compareDates(Date firstDate,
                                   Date secondDate) {
        Date firstDateClone = new Date(firstDate.getYear(),
                                       firstDate.getMonth(),
                                       firstDate.getDate());
        Date secondDateClone = new Date(secondDate.getYear(),
                                        secondDate.getMonth(),
                                        secondDate.getDate());
    ...
    public static Date getSameOrClosestDateInPreviousMonth(Date date) {
        ...
        CalendarUtil.addMonthsToDate(desiredDate,
                                     -1);
        if (desiredDate.getMonth() == date.getMonth()) {
            ...
            CalendarUtil.addDaysToDate(desiredDate,
                                       -1);
        }
        return desiredDate;
    }
